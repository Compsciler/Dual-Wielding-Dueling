...
{
    public class ProjectileGrapple : ProjectileBase
    {
        ...
        void OnEnable()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<ProjectileBase, ProjectileGrapple>(m_ProjectileBase, this,
                gameObject);
        ...
        void StartSwing(Vector3 point)
        {
            ...
            PlayerCharacterController player = FindObjectOfType<PlayerCharacterController>();  // TODO: don't use FindObject
                ...
                float dist = Vector3.Distance(player.transform.position, swingPoint);
